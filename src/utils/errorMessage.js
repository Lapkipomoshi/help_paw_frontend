...
export const NEWS_NAME = {
  NOT_FOUND: 'Введите название новости',
  TOO_LONG: 'Название новости не может превышать 1 500 симоволов',
};

// текст новости
export const NEWS_TEXT = {
  NOT_FOUND: 'Введите текст новости',
  TOO_SHORT: 'Текст новости не может быть меньше 15 000 симоволов',
};
  ...
  return (
    <main className='main new-page'>
      ...
      <p className='new-page__text'>
        Выражаем большую благодарность ученикам 4 "Е" класса московской школы №2010 за подарки для наших подопечных!
        А также благодарим преподавательницу Людмилу и её супруга Александра за организацию транспортировки помощи в
        приют.
      </p>
      <p className='new-page__text'>
